...
<html>
  <head>
    ...
    <title>Club de Baloncesto - Modificación</title>
  </head>
  <body>
        ...
        <div class="panel-heading text-center">Modificación de socio</div>
          <form method="get" action="grabaSocioModificado.jsp">
            <div class="form-group"> 
              <label>&nbsp;&nbsp;Nº de socio:&nbsp;</label><input type="text" size="5" name="socioID" value="<%= request.getParameter("socioID") %>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>&nbsp;&nbsp;Nº Entradas:&nbsp;</label><input type="text" name="numEntradas" size="5" value="<%= request.getParameter("numEntradas") %>" readonly>
            </div>
            <hr>
