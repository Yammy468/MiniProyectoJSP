...
<html>
  <head>
    ...
    <title>Club de Baloncesto - Lista de Socio</title>
  </head>
  ...
  <body>
      ...
      <div class="panel panel-primary">
        ...
        <%
          ...
          ResultSet listado = s.executeQuery ("SELECT * FROM socio ORDER BY 1");
        %>

        <table class="table table-striped">
        <tr><th>Nº de socio</th><th>Nombre</th><th>Estatura</th><th>Edad</th><th>Localidad</th><th>Nª Entradas</th></tr>
        <form method="get" action="grabaSocio.jsp">
          <tr><td><input type="text" name="socioID" size="5"></td>
              ...
              <td><input type="text" name="localidad" size="15"></td>
              <td><input type="text" name="numEntradas" size="4"></td>
        ...
        <%
          while (listado.next()) {
            ...
            out.println("<td>" + listado.getString("numEntradas") + "</td>");
        %>
        <td>
          <form method="get" action="modificaSocio.jsp">
            ...
            <input type="hidden" name="numEntradas" value="<%=listado.getString("numEntradas") %>">
      ...
      <a class="nav-link" href="../logout.jsp">Home</a>
      <div class="text-center">&copy; Yana Zhu</div>
    </div>
